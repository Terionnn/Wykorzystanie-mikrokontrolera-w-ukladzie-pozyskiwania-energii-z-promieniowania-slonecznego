...
void INA219_Reset()
{
    ...
    addr[0] = (data >> 8) & 0xff;
    addr[1] = (data >> 0) & 0xff;
    HAL_I2C_Mem_Write(&hi2c2, INA219_ADDR, 0x00, 1, addr, 2, 100);
}
...
void INA219_Calibrate()
{
	...
	uint8_t addr[2];
	addr[0] = (calibration >> 8) & 0xff;
	addr[1] = (calibration >> 0) & 0xff;
    HAL_I2C_Mem_Write(&hi2c2, INA219_ADDR, 0x05, 1, addr, 2, 100);
